...
def test_delete_user_topic_handler() -> None:
...
def test_delete_non_existent_topic_raises_exception() -> None:
    topic_repo_mock = MagicMock()
...
def test_delete_topic_with_different_user_raises_exception() -> None:
