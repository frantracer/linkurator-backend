...
@pytest.mark.asyncio()
async def test_unassign_subscription_from_user_topic_handler() -> None:
...
@pytest.mark.asyncio()
async def test_unassign_subscription_from_non_existent_topic_raises_an_exception() -> None:
...
@pytest.mark.asyncio()
async def test_unassign_subscription_from_a_different_user_topic_raises_an_exception() -> None:
...
@pytest.mark.asyncio()
async def test_unassign_non_existent_subscription_from_user_topic_does_nothing() -> None:
