...
def fixture_interaction_repo(db_name: str) -> MongoDBInteractionRepository:
...
def test_get_interaction(interaction_repo: MongoDBInteractionRepository) -> None:
...
def test_delete_interaction(interaction_repo: MongoDBInteractionRepository) -> None:
    interaction = Interaction.new(
...
def test_get_interactions_by_item(interaction_repo: MongoDBInteractionRepository) -> None:
