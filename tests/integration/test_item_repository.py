...
async def test_delete_item(item_repo: ItemRepository) -> None:
    ...
    await item_repo.delete_item(item.uuid)
    deleted_item = await item_repo.get_item(item.uuid)
...
async def test_create_and_update_items(item_repo: ItemRepository) -> None:
    ...
    item1_found = await item_repo.get_item(item1.uuid)
    item2_found = await item_repo.get_item(item2.uuid)
...
async def test_find_items_with_every_interaction(
    ...
    await item_repo.upsert_items([item1, item2, item3, item4, item5, item6, item7, item8, item9, item10])
...
async def test_delete_interaction(item_repo: ItemRepository) -> None:
    ...
    await item_repo.delete_interaction(interaction.uuid)
...
async def test_get_interactions_by_item(item_repo: ItemRepository) -> None:
    ...
    interactions = await item_repo.get_user_interactions_by_item_id(
