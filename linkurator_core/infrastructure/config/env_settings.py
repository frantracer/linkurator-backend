...
class EnvSettings(BaseModel):
    ...
    GOOGLE_YOUTUBE_SECRET_PATH: str = os.getenv(
        'LINKURATOR_GOOGLE_YOUTUBE_SECRET_PATH', "secrets/client_secret_youtube.json")
    SPOTIFY_SECRET_PATH: str = os.getenv('LINKURATOR_SPOTIFY_SECRET_PATH', "secrets/spotify_credentials.json")
