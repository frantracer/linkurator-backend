...
from linkurator_core.domain.common.exceptions import UserNotFoundError, UsernameAlreadyInUseError
    ...
    async def handle(
        ...
        if new_attributes.username:
            ...
            if existing_user is not None:
                raise UsernameAlreadyInUseError(f"Username {new_attributes.username} already in use")
